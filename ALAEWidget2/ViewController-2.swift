...
class ViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // iOS 16.4+ : sans ce drapeau, la WebView n'apparaît pas dans Safari › Développement.
            ...
            DispatchQueue.main.async {
                ...
                for prayer in prayers {
                    ...
                    if reciter != "silent" {
                        ...
                        // au-delà, iOS ignore le son et la notification arrive muette.
                        // Repli sur hadioui si le récitateur choisi n'a pas de fichier -notif.
